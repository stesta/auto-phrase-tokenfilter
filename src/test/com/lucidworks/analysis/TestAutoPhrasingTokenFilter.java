...
public class TestAutoPhrasingTokenFilter extends TestCase {
  ...
  public void testAutoPhrase( ) throws Exception {
    final CharArraySet phraseSets = new CharArraySet(org.apache.lucene.util.Version.LUCENE_4_10_3, Arrays.asList(
    ...
    final WhitespaceTokenizer in = new WhitespaceTokenizer(org.apache.lucene.util.Version.LUCENE_4_10_3, reader );
