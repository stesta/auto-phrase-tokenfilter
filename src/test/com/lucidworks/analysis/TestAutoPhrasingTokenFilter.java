...
public class TestAutoPhrasingTokenFilter extends TestCase {
  ...
  public void testAutoPhrase( ) throws Exception {
    final CharArraySet phraseSets = new CharArraySet(org.apache.lucene.util.Version.LUCENE_45, Arrays.asList(
    ...
    final WhitespaceTokenizer in = new WhitespaceTokenizer(org.apache.lucene.util.Version.LUCENE_45, reader );
